$(document).ready(function(){
    $(".affirm,.timer,#newBlocks2,#newBlocks6,.lost,.no,#window1").hide();
    $("#SlidingWindow").click(function(){

        /*******************************************************/

        $(".blocks,.affirm,.lost,.no,.timer").delay(1000);//延迟1500ms后动画开始
...
//      });
        var win = $("#window0");
        win.delay(2500);
        win.animate({left:'75px'},50);
        win.delay(2500).animate({left:'+=75px'},50);
        win.delay(5000).animate({left:'+=75px'},50);
        win.delay(2500).animate({left:'+=75px'},50);
        win.delay(2500).animate({left:'+=75px'},50);
        win.delay(2500).animate({left:'+=75px'},50);
        win.delay(5500).animate({left:'+=75px'},50);
        win.delay(2500).animate({left:'+=75px'},50);
