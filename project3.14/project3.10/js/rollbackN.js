...
/*******************************************************/
    ...
    $("#newBlocks2").delay(9400).fadeIn(250).animate({bottom:'420px'},2000,function(){$("#affirm2").toggle(0).animate({top:'420px'},2000);});//计时器作用后，1s后生成新帧，并发送给接收方2s，接收方接受帧后回发确认帧2s。
      ...
      }).delay(3500).animate({bottom:'+=50px',opacity:0},500);//blocks3延迟3500ms后消失
      $("#newAffirm11").delay(6200).toggle(0).animate({top:'420px'},2000);
      $("#newAffirm12").delay(6400).toggle(0).animate({top:'420px'},2000);
