$(document).ready(function(){
    $(".affirm,.timer,.new-blocks,.no").hide();
...
/*******************************************************/
    ...
    $("#newBlocks2").delay(9400).fadeIn(250).animate({bottom:'420px'},2000,function(){$("#affirm2").toggle(0).animate({top:'420px'},2000);});//计时器作用后，1s后生成新帧，并发送给接收方。接收方接受帧后回发确认帧。
